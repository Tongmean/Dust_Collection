...
export const fetchTypes = async () => {
  try {
    const response = await apiClient.get('/type'); // Send the GET request to the server
...
export const fetchType = async (id) => {
  try {
    const response = await apiClient.get(`/type/${id}`); // Send the GET request to the server
...
export const createType = async (typeData) => {
  try {
    const response = await apiClient.post(`/type/post`, typeData); // Send the GET request to the server
...
export const updateType = async (id, updatedtype) => {
  try {
    const response = await apiClient.put(`/type/update/${id}`, updatedtype); // Send the GET request to the server
